...
We view these findings not as a discouraging result, but as thought-provoking and exciting. Vogel and Awh \citep{vogel2008} argued that studying individual differences in cognitive psychology (in their case, working memory) provides valuable insight to containing potential theories of the underlying cognitive mechanisms. Our results suggest that context and structure of the task also needs to be taken into account. Understanding how an individual's behaviour varies across different search tasks can lead to the development of a more comprehensive theory of search. 
