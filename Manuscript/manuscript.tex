...
Each search display was composed of 54 red, blue, green and variable-coloured small squares arranged in three concentric rings around fixation (see \ref{fig:exampleStimuli}). Variable distractors changed colours from trial-to-trial according to a 24 trial cyclical pattern: these distractors would be red for five trials, then across a period of seven trials, they would gradually change colour from red to blue. The variable distractors would then be blue for five trials, and then gradually transition back to red. 
%A missing detail reviewers might want to know here is how many distractors are variable vs fixed colors 
