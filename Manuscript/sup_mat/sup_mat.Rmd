...
```{r rt_plt, fig.cap = "Distribution of reaction times in split-half paradigm.", echo = FALSE, warning = FALSE, message = FALSE, fig.align = "center"}
plt <- ls_acc_RT %>%
  ggplot(aes(rt)) + 
  geom_histogram() + 
  theme_bw() +  
