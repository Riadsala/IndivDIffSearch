...
```
A participant was excluded if their accuracy in the task was more than 3 standard deviations below the average for all participants. Participants `r paste(excluded[1], "&", excluded[2])` were excluded for having an accuracy that was 3 standard deviations below the global average of `r round(avg_1, digits = 2)`.
